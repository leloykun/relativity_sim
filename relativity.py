...
if __name__ == '__main__': 
    ...
    #env = Environment(sim_type='train_time', light_type='lorrentz')
    #env = Environment(sim_type='train_notime', light_type='lorrentz')
    #env = Environment(sim_type='ground_notime', light_type='lorrentz')
